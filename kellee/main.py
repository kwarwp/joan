...
def criarsalas():
 ...
 edi.entra(a_norte)
 txtedi = Texto(a_norte, "Bem Vindo, caro visitante, nesse jogo vocÃÂª irÃÂ¡ conhecer um pouco da UFRJ, a CCMN!")
 edi.vai = txtedi.vai
 
 ed.entra(a_leste)
 txted = Texto(a_leste, "Aqui ÃÂ© a saÃÂ­da, nÃÂ£o vamos embora agora, vamos a visita!")
 ed.vai = txted.vai
 
 ed1.entra(b_norte)
 txted1 = Texto(b_norte, "Aqui ÃÂ© a entrada, para passarmos da catraca precisamos falar com o guarda a sua direita.")
 ed1.vai = txted1.vai
 
 ed2.entra(b_leste)
 txted2 = Texto(b_leste, "VÃÂ¡ atÃÂ© o atendimento para falar com o guarda, ele lhe darÃÂ¡ as o que ÃÂ© necessÃÂ¡rio pra passar pela catraca.")
 ed2.vai = txted2.vai
 ...
 ed4.entra(d_oeste)
 txted4 = Texto(d_oeste, "Logo mais a frente haverÃÂ¡ uma porta a sua esquerda, entre nela.")
 ed4.vai = txted4.vai
 
 ed5.entra(f_norte)
 txted5 = Texto(f_norte, "Esse ÃÂ© o corredor que leva a nossa sala de aula, vire as proximas duas esquerdas e chegaremos a nossa sala.")
 ed5.vai = txted5.vai
 ...
 ed13.entra(d_norte)
 txted13 = Texto(d_norte, "O CCMN foi fundado em 1967 por TÃÂ©rcio Pacitti!")
 ...
 ed23.entra(g_norte)
 txted23 = Texto(g_norte, "Essa ÃÂ© a sala que normalmente ficamos, onde a magia ocorre!")
 ...
 txted26 = Texto(g_secreto, "Essa ÃÂ© parte da atual turma desse curso de programaÃÂ§ÃÂ£o!")
 ed26.vai = txted26.vai
 
 guarda.entra(b_lestea)
 txtguarda = Texto(b_lestea, "Bom dia, vocÃÂª ÃÂ© do curso de programaÃÂ§ÃÂ£o nÃÂ£o ÃÂ©? Tome o cartÃ£o de acesso e passe pela catraca.")
