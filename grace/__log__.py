...
'''},
{'date': 'Fri Apr 24 2020 13:11:04.430 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 60
    escolheu = escolhe[escolha](seu_nome)
...
SyntaxError: EOL while scanning string literal
'''},
{'date': 'Thu Jun 24 2021 10:18:52.667 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
...
'''},
{'date': 'Thu Jun 24 2021 10:52:27.116 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 25
    self.isaias = Isaias()
  module <module> line 44
    self.cibele = J.a(self.CIBELE, y=400, w=200, h=250, cena=self.isaias)
AttributeError: 'Isaias' object has no attribute 'CIBELE'
'''},
{'date': 'Thu Jun 24 2021 11:31:10.594 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
'''},
{'date': 'Thu Jun 24 2021 12:06:43.902 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
SyntaxError: invalid syntax
'''},
{'date': 'Thu Jun 24 2021 12:32:20.650 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 104
    self.anuncia.esquerda = J.c("", vai=self.voz)
AttributeError: 'Zacarias' object has no attribute 'voz'
'''},